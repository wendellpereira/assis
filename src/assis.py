        ...
        try:
            ...
            with message_stream as stream:
                ...
                for chunk in stream:
                    ...
                    model_used = getattr(getattr(chunk, 'message', None), 'model', None)
                    if model_used:
            ...
            # Update model used
            if model_used and st.session_state.current_conversation_id is not None:
